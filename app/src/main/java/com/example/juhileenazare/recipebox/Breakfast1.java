...
import com.example.juhileenazare.recipebox.Breakfast;
...
public class Breakfast1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.selected_ingredients=Breakfast.selected_ingredients;
        ...
        try{
            ...
            String[] files=assetManager.list("BreakFast");
            String s5="$";
            String s=null;
            ...
            ArrayAdapter<String> adapter=new ArrayAdapter<String>(Breakfast1.this,R.layout.r_list,R.id.label,r_names);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent=new Intent(Breakfast1.this,Breakfast2.class);
