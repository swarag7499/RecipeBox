...
public class Snacks1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.selected_ingredients=Snacks.selected_ingredients;
        ...
        try{
            ...
            String[] files=assetManager.list("Snacks");
            String s5="$";
            String s=null;
            ...
            ArrayAdapter<String> adapter=new ArrayAdapter<String>(Snacks1.this,R.layout.r_list,R.id.label,r_names);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent=new Intent(Snacks1.this,Snacks2.class);
