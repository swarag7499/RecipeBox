...
public class Lunch_1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_1);
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public CustomAdapter(Lunch_1 Lunch1, String[] osNameList, int[] osImages) {
    ...
    public void nextBtn(View view){
        Intent intent=new Intent(Lunch_1.this,Lunch4.class);
